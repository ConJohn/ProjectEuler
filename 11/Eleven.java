...
public class Eleven
{
    ...
    {
        int[][] n = new int[][]{
                {8,2,22,97,38,15,00,4,00,75,4,5,7,78,52,12,5,77,91,8},
                {49,49,99,4,17,81,18,57,6,87,17,4,98,43,69,48,4,56,62,00},
                ...
                {21,36,23,9,75,00,76,44,2,45,35,14,00,61,33,97,34,31,33,95},
                {78,17,53,28,22,75,31,67,15,94,3,8,4,62,16,14,9,53,56,92},
                {16,39,5,42,96,35,31,47,55,58,88,24,00,17,54,24,36,29,85,57},
                {86,56,00,48,35,71,89,7,5,44,44,37,44,6,21,58,51,54,17,58},
        ...
        {
            for(int k = 0; k < n[j].length-3; k++)
            {
                int out = n[j][k] * n[j][k+1] * n[j][k+2] * n[j][k+3];
                if(out>max)
                {
                    max = out;
                }
        ...
        for(int j = 0; j < n.length-3; j++)
        {
            for(int k = 0; k < n[j].length-3; k++)
            {
                int out = n[j][k] * n[j+1][k+1] * n[j+2][k+2] * n[j+3][k+3];
                if(out>max)
                {
                    max = out;
                }
